...
This project implements a layered architecture with the Repository Pattern and JWT authentication, following clean code principles and separation of concerns.
